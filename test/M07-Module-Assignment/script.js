...
document.getElementById('hotel1').innerHTML = elHotel1.innerHTML;

var details2 = parkHotel.name + ' rooms: ';
    details2 += parkHotel.checkAvailability();
var elHotel2 = document.getElementById('hotel2');
elHotel2.textContent = details2;
document.getElementById('hotel2').innerHTML = elHotel2.innerHTML;
...
document.getElementById('hotel3').innerHTML = elHotel3.innerHTML;
/* 
